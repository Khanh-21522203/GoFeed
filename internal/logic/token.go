...
type TokenLogic interface {
	...
	GetAccountIDAndExpireTime(ctx context.Context, tokenString string) (uint64, time.Time, error)
...
func (t token) WithDatabase(database database.Database) TokenLogic {
	return token{}
}
